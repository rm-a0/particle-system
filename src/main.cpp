...
ParticleManager test() {
    ParticleManager manager;
        for (float i = -200.0; i <= -100.0; i+= 5) {
            Particle p1 (CIRCLE, glm::vec3(), glm::vec3(1, 1, 0), glm::vec3(), 10.0, 0.2, Color(1.0, 0.5, 1.0, 1.0), Color(1.0, 0.5));
...
ParticleManager shapeTest() {
    ParticleManager manager;
    Particle p1 (CIRCLE, glm::vec3(), glm::vec3(0, 0, 0), glm::vec3(), 10.0, 2, Color(1.0, 0.5, 1.0, 1.0), Color(1.0, 0.5));
    ParticleEmitter e1 (glm::vec3(0, 0, 0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(), 9, 10, p1, &manager);
    manager.addParticleEmitter(e1);
    return manager;
}
